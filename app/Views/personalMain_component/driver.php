<div class="mb-3">
    ...
    <input type="text" class="form-control" id="company_name" name="clearingCompany_name" value="<?php echo $company['clearingCompany_name']?>" disabled>
</div>
<div class="mb-3">
    <label for="company_number" class="form-label">公司統編</label>
    <input type="text" class="form-control" id="company_number" name="clearingCompany_uniformNumbers"  value="<?php echo $company['clearingCompany_uniformNumbers']?>" disabled>
</div>
<div class="mb-3">
