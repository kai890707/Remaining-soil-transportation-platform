...
<div class="container">
    <div class="row mt-4 p-0  ">
        <div class=" col-11 bg-light shadow p-4 m-1  mx-auto shadow">
            <form id="driver_personal_form">
                <?= $this->include('personalMain_component/driver');?>
            </form>
        </div>
...
<script>
    ...
    $("form[id='driver_personal_form']").submit(function(e) {
        e.preventDefault();
        var formData = new FormData(document.getElementById('driver_personal_form'));
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                BaseLib.Post("/clearingDriver/personalUpdate",formData).then(
                (res)=>{
