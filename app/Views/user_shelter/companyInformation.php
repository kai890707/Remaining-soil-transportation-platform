        ...
        <div class=" col-11 bg-light shadow p-4 m-1  mx-auto shadow rounded ">
            ...
            <div class="row">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="company_name" name="company_name" value="<?php echo $info['containmentCompany_name'];?>" disabled>
                </div>
                <div class="mb-3">
                    <label for="company_number" class="form-label">公司統編</label>
                    <input type="text" class="form-control" id="company_number" name="company_number"  value="<?php echo $info['containmentCompany_uniformNumbers'];?>" disabled>
                </div>
                <div class="mb-3">
                    <label for="company_address" class="form-label">公司地址</label>
                    <input type="text" class="form-control" id="company_address" name="company_address"  value="<?php echo $info['containmentCompany_address'];?>" disabled>
                </div>
